...
blood <- read.csv('~/Documents/Projects/AgingBrainStudy/data/HABS/processed/blood_biomarkers.csv', na.strings = c("", " ", "NaN", "NA", NA))
data <- merge(data, blood, by = 'SubjIDshort', all = TRUE)
```
