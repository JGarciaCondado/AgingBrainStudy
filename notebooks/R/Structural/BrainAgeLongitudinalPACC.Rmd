...
```{r}
pwr_pacc_A4 <- lmmpower(lmm_results_A4_pacc, parameter = "pacc_time", pct.change = 0.4, t = seq(0, 5, 0.5), sig.level = 0.05, power = 0.8)
pwr_old_A4 <- lmmpower(lmm_results_A4_pacc_old, parameter = "pacc_time", pct.change = 0.4, t = seq(0, 5, 0.5), sig.level = 0.05, power = 0.8)
print(pwr_pacc_A4$N)
print(pwr_old_A4$N)
...
```{r}
pwr_pacc_habs <- lmmpower(lmm_results_habs_pacc, pct.change = 0.4, t = seq(0, 5, 0.5), sig.level = 0.05, power = 0.8)
pwr_old_habs <- lmmpower(lmm_results_habs_pacc_old, pct.change = 0.4, t = seq(0, 5, 0.5), sig.level = 0.05, power = 0.8)
