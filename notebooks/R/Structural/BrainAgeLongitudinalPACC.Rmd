...
library(ggplot2); library(ggpubr);library(dplyr);library(nlme);library(sjPlot);library(gtsummary);library(MuMIn);library(gt);library(ggeffects);library(effsize)
...
cat("Delta effect:", signif(a4_delta_effects$delta.estimate, 2), 
    "[", signif(a4_delta_effects$delta.lower_ci, 2), ",",
    signif(a4_delta_effects$delta.upper_ci, 2), "]",
...
cat("BrainAge delta * AB effect:", signif(a4_ab_effects$ab.estimate, 2), 
    "[", signif(a4_ab_effects$ab.lower_ci, 2), ",",
    signif(a4_ab_effects$ab.upper_ci, 2), "]",
...
cat("BrainAge delta * pTau217 effect:", signif(a4_ptau_effects$ptau.estimate, 2), 
    "[", signif(a4_ptau_effects$ptau.lower_ci, 2), ",",
    signif(a4_ptau_effects$ptau.upper_ci, 2), "]",
...
cat("BrainAge delta * tau217 effect:", signif(a4_tau_effects$tau.estimate, 2), 
    "[", signif(a4_tau_effects$tau.lower_ci, 2), ",",
    signif(a4_tau_effects$tau.upper_ci, 2), "]",
...
Find Optimal Delta Threshold that seperates younger and older groups.

```{r}
a4_formula = "I(time_mri^2) + time_mri*delta_status + Cumulative_Dose_Scaled + time_mri*cohort + LMSTORY"
a4_random_formula = " ~ time_mri|ID"
mean_a4_delta_cn = mean(data_a4$delta, na.rm = TRUE)
sd_a4_delta_cn = sd(data_a4$delta, na.rm = TRUE)
results_a4 <- find_optimal_threshold(data_a4, seq(mean_a4_delta_cn-2*sd_a4_delta_cn, 
                                                  mean_a4_delta_cn + 2*sd_a4_delta_cn, by = 0.25*sd_a4_delta_cn), 
                                   outcome = "PACC",
                                   measure = "delta", 
                                   fixed_formula = a4_formula, 
                                   random_formula = a4_random_formula)
print(results_a4$plot)
cat("Optimal threshold:", results_a4$optimal_threshold, "\n")
cat("Optimal threshold z-score:", results_a4$optimal_threshold_sd, "\n")
```
...
cat("Delta effect:", signif(habs_delta_effects$delta.estimate, 2), 
    "[", signif(habs_delta_effects$delta.lower_ci, 2), ",",
    signif(habs_delta_effects$delta.upper_ci, 2), "]",
...
cat("BrainAge delta * AB effect:", signif(habs_ab_effects$ab.estimate, 2), 
    "[", signif(habs_ab_effects$ab.lower_ci, 2), ",",
    signif(habs_ab_effects$ab.upper_ci, 2), "]",
...
cat("BrainAge delta * pTau217 effect:", signif(habs_ptau_effects$ptau.estimate, 2), 
    "[", signif(habs_ptau_effects$ptau.lower_ci, 2), ",",
    signif(habs_ptau_effects$ptau.upper_ci, 2), "]",
...
cat("BrainAge delta * tau217 effect:", signif(habs_tau_effects$tau.estimate, 2), 
    "[", signif(habs_tau_effects$tau.lower_ci, 2), ",",
    signif(habs_tau_effects$tau.upper_ci, 2), "]",
...
```{r}
habs_formula = "I(time_mri^2) + time_mri*delta_status"
habs_random_formula = " ~ time_mri|ID"
mean_habs_delta_cn = mean(data_habs$delta, na.rm = TRUE)
sd_habs_delta_cn = sd(data_habs$delta, na.rm = TRUE)
results_habs <- find_optimal_threshold(data_habs, seq(mean_habs_delta_cn-2*sd_habs_delta_cn, 
                                                    mean_habs_delta_cn + 2*sd_habs_delta_cn, by = 0.2*sd_habs_delta_cn), 
                                   outcome = "PACC", 
                                   measure = "delta", 
                                   fixed_formula = habs_formula, 
                                   random_formula = habs_random_formula)
print(results_habs$plot)
cat("Optimal threshold:", results_habs$optimal_threshold, "\n")
cat("Optimal threshold z-score:", results_habs$optimal_threshold_sd, "\n")
```
...
cat("Delta effect:", signif(adni_cn_delta_effects$delta.estimate, 2), 
    "[", signif(adni_cn_delta_effects$delta.lower_ci, 2), ",",
    signif(adni_cn_delta_effects$delta.upper_ci, 2), "]",
...
cat("BrainAge delta * AB effect:", signif(adni_cn_ab_effects$ab.estimate, 2), 
    "[", signif(adni_cn_ab_effects$ab.lower_ci, 2), ",",
    signif(adni_cn_ab_effects$ab.upper_ci, 2), "]",
...
cat("BrainAge delta * pTau217 effect:", signif(adni_cn_ptau_effects$ptau.estimate, 2), 
    "[", signif(adni_cn_ptau_effects$ptau.lower_ci, 2), ",",
    signif(adni_cn_ptau_effects$ptau.upper_ci, 2), "]",
...
cat("BrainAge delta * tau217 effect:", signif(adni_cn_tau_effects$tau.estimate, 2), 
    "[", signif(adni_cn_tau_effects$tau.lower_ci, 2), ",",
    signif(adni_cn_tau_effects$tau.upper_ci, 2), "]",
...
```{r}
adni_cn_formula = "I(time_mri^2) + time_mri*delta_status"
adni_cn_random_formula = " ~ time_mri|ID"
mean_adni_cn_delta = mean(data_adni_cn$delta, na.rm = TRUE)
sd_adni_cn_delta = sd(data_adni_cn$delta, na.rm = TRUE)
results_adni_cn <- find_optimal_threshold(data_adni_cn, seq(mean_adni_cn_delta-2*sd_adni_cn_delta, 
                                                            mean_adni_cn_delta + 2*sd_adni_cn_delta, by = 0.25*sd_adni_cn_delta), 
                                   outcome = "PACC", 
                                   measure = "delta", 
                                   fixed_formula = adni_cn_formula, 
                                   random_formula = adni_cn_random_formula)
print(results_adni_cn$plot)
cat("Optimal threshold:", results_adni_cn$optimal_threshold, "\n")
cat("Optimal threshold z-score:", results_adni_cn$optimal_threshold_sd, "\n")
```
...
cat("Delta effect:", signif(adni_mci_delta_effects$delta.estimate, 2), 
    "[", signif(adni_mci_delta_effects$delta.lower_ci, 2), ",",
    signif(adni_mci_delta_effects$delta.upper_ci, 2), "]",
...
cat("BrainAge delta * AB effect:", signif(adni_mci_ab_effects$ab.estimate, 2), 
    "[", signif(adni_mci_ab_effects$ab.lower_ci, 2), ",",
    signif(adni_mci_ab_effects$ab.upper_ci, 2), "]",
...
cat("BrainAge delta * pTau217 effect:", signif(adni_mci_ptau_effects$ptau.estimate, 2), 
    "[", signif(adni_mci_ptau_effects$ptau.lower_ci, 2), ",",
    signif(adni_mci_ptau_effects$ptau.upper_ci, 2), "]",
...
# Save model
adni_mci_ptau_p <- adni_mci_ptau_p +
  theme(
      text = element_text(family = "Times New Roman", size = 12),
      axis.text = element_text(family = "Times New Roman", size = 12),
      axis.title = element_text(family = "Times New Roman", size = 12),
...
cat("BrainAge delta * tau217 effect:", signif(adni_mci_tau_effects$tau.estimate, 2), 
    "[", signif(adni_mci_tau_effects$tau.lower_ci, 2), ",",
    signif(adni_mci_tau_effects$tau.upper_ci, 2), "]",
...
```{r}
adni_mci_formula = "I(time_mri^2) + time_mri*delta_status"
adni_mci_random_formula = " ~ time_mri|ID"
mean_adni_mci_delta = mean(data_adni_mci$delta, na.rm = TRUE)
sd_adni_mci_delta = sd(data_adni_mci$delta, na.rm = TRUE)
results_adni_mci <- find_optimal_threshold(data_adni_mci, seq(mean_adni_mci_delta-2*sd_adni_mci_delta, 
                                                              mean_adni_mci_delta + 2*sd_adni_mci_delta, by = 0.25*sd_adni_mci_delta), 
                                   outcome = "PACC", 
                                   measure = "delta", 
                                   fixed_formula = adni_mci_formula, 
                                   random_formula = adni_mci_random_formula)
print(results_adni_mci$plot)
cat("Optimal threshold:", results_adni_mci$optimal_threshold, "\n")
cat("Optimal threshold z-score:", results_adni_mci$optimal_threshold_sd, "\n")
cat("Optimal threshold relative to CN:", (results_adni_mci$optimal_threshold - mean_adni_cn_delta)/sd_adni_cn_delta, "\n")
```
...
forest_plot <- ggplot(delta_interaction_results, aes(x = delta.estimate, y = model)) +
  ...
  geom_text(aes(x = delta.estimate , 
                label = sprintf("p = %.2g", delta.p_value)),
                vjust = 2.5, size = 7 / .pt) +
...
forest_plot <- ggplot(ab_interaction_results, aes(x = ab.estimate, y = model)) +
  ...
  theme_minimal() +
  # Add effect size values to the plot 
  geom_text(aes(x = ab.estimate , 
                label = sprintf("p = %.2g", ab.p_value)),
                vjust = 2.5, size = 7 / .pt) +
  scale_x_continuous(limits = c(-0.5, 0.2))
...
forest_plot <- ggplot(ptau_interaction_results, aes(x = ptau.estimate, y = model)) +
  ...
  theme_minimal() +
  # Add effect size values to the plot 
  geom_text(aes(x = ptau.estimate , 
                label = sprintf("p = %.2g", ptau.p_value)),
                vjust = 2.5, size = 7 / .pt) +
  scale_x_continuous(limits = c(-0.5, 0.2))
...
forest_plot <- ggplot(tau_interaction_results, aes(x = tau.estimate, y = model)) +
  ...
  theme_minimal() +
  # Add effect size values to the plot 
  geom_text(aes(x = tau.estimate , 
                label = sprintf("p = %.2g", tau.p_value)),
                vjust = 2.5, size = 7 / .pt) +
  scale_x_continuous(limits = c(-0.5, 0.2))
