...
```{r}
ggplot(subset(data_adni_cn, !is.na(PACC)), aes(x = time_mri, y = PACC, group = ID, colour = delta_group)) +
  geom_line() +
  geom_point() +
...
```{r}
ggplot(subset(data_adni_cn, !is.na(PACC)), aes(x = time_mri, y = PACC_change, group = ID, colour = delta_group)) +
  geom_line() +
  geom_point() +
...
```{r}
lmm_results_ADNI_ptau_cn <- lme(PACC ~ time_mri*delta*ptau, data = data_adni_cn, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_ptau_sens_cn <- lme(PACC~ time_mri*delta*ptau + time_mri*mri_age + time_mri*e4_carrier + time_mri*ab_status + time_mri*sex + time_mri*edu, data = data_adni_cn, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_tau_cn <- lme(PACC ~ time_mri*delta*tau_composite, data = data_adni_cn, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_tau_sens_cn <- lme(PACC~ time_mri*delta*tau_composite + time_mri*mri_age + time_mri*e4_carrier + time_mri*ab_status + time_mri*sex + time_mri*edu, data = data_adni_cn, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
ggplot(subset(data_adni_mci, !is.na(PACC)), aes(x = time_mri, y = PACC, group = ID, colour = delta_group)) +
  geom_line() +
  geom_point() +
  labs(title = 'PACC Trajectories', x = 'Time from MRI', y = 'PACC') +
  theme_minimal()
...
```{r}
ggplot(subset(data_adni_mci, !is.na(PACC)), aes(x = time_mri, y = PACC_change, group = ID, colour = delta_group)) +
  geom_line() +
  geom_point() +
  labs(title = 'PACC Trajectories', x = 'Time from MRI', y = 'PACC change from Basline') +
  theme_minimal()
...
```{r}
lmm_results_ADNI_amyl_sens_mci <- lme(PACC~ time_mri*delta*ab_composite + time_mri*mri_age + time_mri*e4_carrier + time_mri*ab_status + time_mri*sex + time_mri*edu, data = data_adni_mci, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_ptau_mci <- lme(PACC ~ time_mri*delta*ptau, data = data_adni_mci, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_tau_mci <- lme(PACC ~ time_mri*delta*tau_composite, data = data_adni_mci, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
...
```{r}
lmm_results_ADNI_tau_sens_mci <- lme(PACC~ time_mri*delta*tau_composite + time_mri*mri_age + time_mri*e4_carrier + time_mri*ab_status + time_mri*sex + time_mri*edu, data = data_adni_mci, random = ~time_mri|ID, na.action = 'na.omit', method = c('ML'));
