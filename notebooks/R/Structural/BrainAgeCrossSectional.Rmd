...
library(ggplot2); library(ggpubr); library(dplyr); library(sjPlot);library(lm.beta);library(metafor)
...
# Store pacc analysis
a4_pacc_standrdized = summary(lm.beta(pacc_analysis$simple_model))
...
a4_ab_standrdized = summary(lm.beta(ab_analysis$simple_model))
...
a4_ptau_standrdized = summary(lm.beta(ptau_analysis$simple_model))
...
# Save standardized results
a4_tau_standrdized = summary(lm.beta(tau_analysis$simple_model))
...
# Store pacc analysis
habs_pacc_standrdized = summary(lm.beta(pacc_analysis$simple_model))
...
# Save standrdized results
habs_ab_standrdized = summary(lm.beta(ab_analysis$simple_model))
...
# Save standardized results
habs_ptau_standrdized = summary(lm.beta(ptau_analysis$simple_model))
...
# Save standardized results
habs_tau_standrdized = summary(lm.beta(tau_analysis$simple_model))
...
# Store pacc analysis
adni_cu_pacc_standrdized = summary(lm.beta(pacc_analysis$simple_model))
...
# Save standrdized results
adni_cu_ab_standrdized = summary(lm.beta(ab_analysis$simple_model))
...
# Save standardized results
adni_cu_ptau_standrdized = summary(lm.beta(ptau_analysis$simple_model))
...
# Save standardized results
adni_cu_tau_standrdized = summary(lm.beta(tau_analysis$simple_model))
...
# Store pacc analysis
adni_mci_pacc_standrdized = summary(lm.beta(pacc_analysis$simple_model))
...
# Save standrdized results
adni_mci_ab_standrdized = summary(lm.beta(ab_analysis$simple_model))
...
# Save standardized results
adni_mci_ptau_standrdized = summary(lm.beta(ptau_analysis$simple_model))
...
# Save standardized results
adni_mci_tau_standrdized = summary(lm.beta(tau_analysis$simple_model))
...
pacc_results <- do.call(rbind, lapply(names(pacc_models), function(name) {
  data.frame(
    model = name,
    estimate = pacc_models[[name]]$coefficients["delta", "Standardized"],
...
ab_results <- do.call(rbind, lapply(names(ab_models), function(name) {
  data.frame(
    model = name,
    estimate = ab_models[[name]]$coefficients["delta", "Standardized"],
...
# AB meta-analysis MCI
ab_mci <- rma(yi = estimate, sei = se, data = ab_results[ab_results$model %in% c("ADNI MCI"), ], method = "ML", test = "z")
cat("AB MCI:", ab_mci$beta, "(", ab_mci$pval, ") \n")
```
...
ptau_results <- do.call(rbind, lapply(names(ptau_models), function(name) {
  data.frame(
    model = name,
    estimate = ptau_models[[name]]$coefficients["delta", "Standardized"],
...
# pTau217 meta-analysis MCI
ptau_mci <- rma(yi = estimate, sei = se, data = ptau_results[ptau_results$model %in% c("ADNI MCI"), ], method = "ML", test = "z")
cat("pTau217 MCI:", ptau_mci$beta, "(", ptau_mci$pval, ") \n")
```
...
tau_results <- do.call(rbind, lapply(names(tau_models), function(name) {
  data.frame(
    model = name,
    estimate = tau_models[[name]]$coefficients["delta", "Standardized"],
...
# Tau meta-analysis MCI
tau_mci <- rma(yi = estimate, sei = se, data = tau_results[tau_results$model %in% c("ADNI MCI"), ], method = "ML", test = "z")
cat("Tau MCI:", tau_mci$beta, "(", tau_mci$pval, ") \n")
```