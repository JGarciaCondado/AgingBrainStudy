...
```{r}
regression_analysis(data, 'PIB_FS_SUVR_FLR', 'tau_composite', c('SEX', 'YrsEd', 'E4_Status', 'PIB_FS_SUVR_Group', 'age'))
```

```{r}
regression_analysis(data, 'ptau', 'tau_composite', c('SEX', 'YrsEd', 'E4_Status', 'PIB_FS_SUVR_Group', 'age'))
```
