...
```{r}
regression_analysis(data_A4, 'Composite_Summary', 'delta_all', c('SEX', 'YearsEd', 'e4', 'BL_Age'))
```
...
```{r}
regression_analysis(data_A4, 'bi_inferiortemporal', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Inferior parietal

```{r}
regression_analysis(data_A4, 'bi_inferiorparietal', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Middle temporal

```{r}
regression_analysis(data_A4, 'bi_middletemporal', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Entorhinal

```{r}
regression_analysis(data_A4, 'bi_entorhinal', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Parahippocampal

```{r}
regression_analysis(data_A4, 'bi_parahippocampal', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Fusiform

```{r}
regression_analysis(data_A4, 'bi_fusiform', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```

### Amygdala

```{r}
regression_analysis(data_A4, 'bi_Amygdala', 'delta_all', c('SEX', 'YearsEd', 'e4', 'Amyloid', 'BL_Age'))
```
